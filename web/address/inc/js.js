...
$(function(){
    ...
    //edit by zjcf
    if(width >= 1279){
        $("#top_nav").css({width:SPAN * 4+"px", height: SPAN * 2+"px"}).children("ul").css("width", SPAN * 6+"px");
        $("li.nav-li.unuse>div").css({width: SPAN +"px", height: SPAN+"px"});
        $("div.hover_right").css("margin-left",SPAN * 7+"px");
    }else{
        if(width<768)width = 768;
        $("#top_nav").css({width:width - SPAN * 3+"px", height: SPAN * 2+"px"}).children("ul").css("width", width - SPAN * 2);
        $("li.nav-li.unuse>div").css({width: width - SPAN * 7, height: SPAN}).find(".line").hide();
...
$(window).resize(function() {
    ...
    width = document.documentElement.clientWidth
    if(width >= 1279){
        $("#top_nav").css({width:SPAN * 4+"px", height: SPAN * 2+"px"}).children("ul").css("width", SPAN * 6+"px").find("li.nav-li .top_nav").css({width: SPAN+"px"});
        $("li.nav-li.unuse>div").css({width: SPAN +"px", height: SPAN+"px"}).find(".line").show();
        $(".hover_right").css({marginLeft: SPAN * 7+"px"})
    }else{
        if(width<768)width = 768;
        $("#top_nav").css({width: width- SPAN*3, height: SPAN * 2+"px"}).children("ul").css({width: width - SPAN*2}).find("li.nav-li .top_nav").css({width: SPAN+"px"});
        $("li.nav-li.unuse>div").css({width: width - SPAN * 7, height: SPAN}).find(".line").hide();
        $(".hover_right").css({marginLeft: 0})
    }
    //end
...
$(function(){
    ...
    $('#top_nav li.nav-li').not(".unuse").hover(
        function(){
            ...
            if(w > 1024){
            _this_.children(".top_nav").stop().animate({width: SPAN*2+"px"},"normal",function(){
        ...
        function(){
            ...
            _this_.children(".top_nav").stop().animate({width: SPAN+"px"},"normal");
            } else {
...
$(function () {
	$('.animate').hover(function(){
        var _this_ = $(this);
		_this_.find('span').stop().animate({"width":"60px"},"slow",function(){
            _this_.find('dl').slideDown('slow');
        });
	},
	function(){
        var _this_ = $(this);
		_this_.find('span').stop().animate({"width":"0px"},"slow");
...
var lazyLayout = function(elem, _option_){
    ...
    var zoomconfig = [ {w: 495, h: 247, l: 248, t: 0},{w: 619, h: 247, l: 248, t: 0},{w: 411, h: 205, l: 206, t: 0},{w: 514, h: 205, l: 206, t: 0},{w: 412, h: 205, l: 0, t: 0}];
    var normalconfig = [
        [
            {w:123, h:123, l:0, t:0},{w:123, h:123, l:124, t:0},{w:123, h:123, l:744, t:0},{w:123, h:123, l:868, t:0},
            {w:123, h:123, l:0, t:124},{w:123, h:123, l:124, t:124},{w:123, h:123, l:744, t:124},{w:123, h:123, l:868, t:124}
        ],
        [
            {w:123, h:123, l:0, t:0},{w:123, h:123, l:124, t:0},{w:123, h:123, l:868, t:0},{w:123, h:123, l:992, t:0},
            {w:123, h:123, l:0, t:124},{w:123, h:123, l:124, t:124},{w:123, h:123, l:868, t:124},{w:123, h:123, l:992, t:124}
        ],
        [
            {w:102, h:102, l:0, t:0},{w:102, h:102, l:103, t:0},{w:102, h:102, l:618, t:0},{w:102, h:102, l:721, t:0},
            {w:102, h:102, l:0, t:103},{w:102, h:102, l:103, t:103},{w:102, h:102, l:618, t:103},{w:102, h:102, l:721, t:103}
        ],
        [
            {w:102, h:102, l:0, t:0},{w:102, h:102, l:103, t:0},{w:102, h:102, l:721, t:0},{w:102, h:102, l:824, t:0},
            {w:102, h:102, l:0, t:103},{w:102, h:102, l:103, t:103},{w:102, h:102, l:721, t:103},{w:102, h:102, l:824, t:103}
        ],
        [
            {w:102, h:102, l:0, t:206},{w:102, h:102, l:103, t:206},{w:102, h:102, l:206, t:206},{w:102, h:102, l:309, t:206},
            {w:102, h:102, l:0, t:309},{w:102, h:102, l:103, t:309},{w:102, h:102, l:206, t:309},{w:102, h:102, l:309, t:309}
        ]
    ];
    var ww = $(window).width();
    var curzoom;
